                ...
                $('#sales_summary_popup_table_data').DataTable({
                    ...
                    "columns": [
                        ...
                        { "data": null,  "render": function ( data, type, full, meta ) {
                         ...
                         return '<span class="btn btn-sm btn-success mr-1"><a href="https://wa.me/'+phone+'/?text=Hi,%0a%0aYour purchase link for program '+data.program_detail+' will expire '+data.expiry_date+'! Click here to pay now: '+data.payment_link+'" class="text-white" target="_blank"><i class="fa fa-whatsapp" aria-hidden="true"></i></a></span><span class="btn btn-sm btn-danger mr-1" onclick="cancel_link(\''+data.id+'\');">Cancel</span>';}},
            ...
            case 'payment_link':
                ...
                $('#sales_summary_popup_table_data').DataTable({
                    ...
                    "columns": [
                        ...
                        return '<span class="btn btn-sm btn-success mr-1"><a href="https://wa.me/'+phone+'/?text=Hi,%0a%0aYour purchase link for program '+data.program_detail+' will expire '+data.expiry_date+'! Click here to pay now: '+data.payment_link+'" class="text-white" target="_blank"><i class="fa fa-whatsapp" aria-hidden="true"></i></a></span>';}},
            ...
            case 'payment_links_expired':
                ...
                $('#sales_summary_popup_table_data').DataTable({
                    ...
                    "columns": [
                        ...
                        return '<span class="btn btn-sm btn-success mr-1"><a href="https://wa.me/'+phone+'/?text=Hi,%0a%0aYour discounted purchase payment link for program '+data.program_name+' ('+data.program_duration+') has expired. It was a very good offer %26 included 30-day additional maintenance too worth Rs.'+data.amount+' complimentary. " class="text-white" target="_blank"><i class="fa fa-whatsapp" aria-hidden="true"></i></a></span>';}},
...
$(document).ready(function(){
    ...
    $('.set_goal_modal').on('click', function(){
        ...
        // window.location.href = "https://www.balancenutrition.in/sales_crm/dashboard";
