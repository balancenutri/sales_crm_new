    	...
    	<div class="m-portlet" id="m_portlet">
    		<div class="m-portlet__body py-3">
    		    <div class="search_section">
    		        <ul class="nav nav-tabs d-none  m-tabs-line position-relative" role="tablist">
        ...
        function order_details_table(){
            ...
            //console.log(base_url);
                ...
                $('#order_details_data').DataTable({
                    "ajax": {
                        "type" : "GET",
                        "url" : "<?php echo base_url()?>dashboard/get_active_payment_links",
                    ...
                    columnDefs: [
                        ...
                        // { "width": "15%", "targets": 5 },
                        {
                            ...
                            targets: [4], render: function (a, b, data, s) {
                                return  "<a target= 'blank' href='https://www.balancenutrition.in/' class='btn btn-danger' title='View Invoice'>Whatsapp</a>";
                            }
                        },
                        {
                            // puts a button in the last column
                            targets: [3], render: function (a, b, data, s) {
                                return '<b>Link :</b> '+data.payment_link;
                            }
                        },
                        {
                            // puts a button in the last column
                            targets: [2], render: function (a, b, data, s) {
                                return '<b>Program Name : </b> '+data.program_name+'<br><b>Program Days : </b> '+data.program_duration+'<br><b>Prog amt.:</b> '+data.amount;
                            }
                        },
                        {
                            // puts a button in the last column
                            ...
                            return '<b><i class="fas fa-user text-info"></i></b> <a href="<?= base_url()?>user_details?user_email='+data.email_id+'&user_status=client" target="_blank">'+data.name+'</a><br><a href="mailto:'+data.email_id+'" target="_blank">'+data.email_id+'</a> <br><a href="tel:'+data.phone+'" target="_blank">'+data.phone+'</a>';
                            }
                        },
                        {
                            // puts a button in the last column
