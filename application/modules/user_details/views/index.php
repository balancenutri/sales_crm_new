...
?>
  ...
  <form method="post" id="client_app_panel_form"  class="needs-validation" enctype="multipart/form-data" action="<?php echo base_url('update-lead-action');?>">
    ...
    <input type="text" id="users_id" name="user_id" value="<?php //echo $user_id; ?>">
      ...
      <div class="m-portlet m-portlet--space user_px_2">
        ...
        <div class="m-portlet__body pt-3">
          ...
          <div class="user_credentials_sec" id="details_data" style="background:<?= $client_color ?> !important">
            ...
            <?php
            if($get_user_details[0]['register_id'])
            {
            ?>
            <!-- Button trigger modal -->
            <button type="button" class="btn btn-sm btn-success mr-3" data-toggle="modal" data-target="#walletModal">Add Wallet</button>
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title text-success" id="walletModalLabel" >Wallet Balance - Rs  <?= @$get_user_details[0]['wallet'] == '' ? '0':$get_user_details[0]['wallet']; ?></h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                      <span aria-hidden="true">&times;</span>
                    </button>
                  </div>
                  <div class="modal-body">
                    <form id="walletFormdata">
                   <!--<div class="box-body" style="border: 1px solid rgb(113, 106, 202); margin-bottom: 20px; padding: 10px 0px;" id="wallet_div">-->
                     <div class="form-group">
                        ...
                        <div class="col-sm-12 col-lg-12">
                           <input type="number" class="form-control" id="wallet_amount" placeholder="Amount">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-12 col-lg-12">
                           <select class="form-control" name="suggested_description" id="suggested_description">
                              <option value="">Select:</option>
                                                            <option value="Any other - Please mention">Any other - Please mention</option>
                                                            <option value="Founders Birthday  ">Founders Birthday  </option>
                                                            <option value="Gave feedback on social media">Gave feedback on social media</option>
                                                            <option value="Gave Video feedback ">Gave Video feedback </option>
                                                            <option value="Good mail">Good mail</option>
                                                            <option value="Inchloss tracker approval">Inchloss tracker approval</option>
                                                            <option value="Limited Period Offer [48 hours Promotion]" selected="selected">Limited Period Offer [48 hours Promotion]</option>
                                                            <option value="Lost 5 kgs / 10 kgs OR  amazing weight loss">Lost 5 kgs / 10 kgs OR  amazing weight loss</option>
                                                            <option value="Milestone achieved">Milestone achieved</option>
                                                            <option value="Occasion / festival">Occasion / festival</option>
                                                            <option value="Participated in contest/challenge">Participated in contest/challenge</option>
                                                            <option value="Participating in BN- Quiz">Participating in BN- Quiz</option>
                                                            <option value="Photo tracker approval">Photo tracker approval</option>
                                                            <option value="Referred a friend/family member/colleagues">Referred a friend/family member/colleagues</option>
                                                            <option value="Regular / punctual">Regular / punctual</option>
                                                            <option value="Shared goals with us">Shared goals with us</option>
                                                            <option value="Shared meal picture">Shared meal picture</option>
                                                            <option value="Social media recommendation">Social media recommendation</option>
                                                            <option value="Spin the Wheel">Spin the Wheel</option>
                                                            <option value="Surprise Credit">Surprise Credit</option>
                                                            <option value="Surprise on the occasion of Dhanteras ">Surprise on the occasion of Dhanteras </option>
                                                            <option value="Valentines Day Gift ">Valentines Day Gift </option>
                                                            <option value="Weight tracker approval">Weight tracker approval</option>
                                                            <option value="Winning BN- Quiz">Winning BN- Quiz</option>
                                                            <option value="Your Reference Enrolled Successfully">Your Reference Enrolled Successfully</option>
                                                         </select>
                        </div>
                     </div>
                     ...
                     <div class="col-sm-5 col-lg-5">
                        <label class="control-label">Add Your Description:<sup class="text-danger">*</sup></label>
                    </div>
                    <div class="col-sm-12">
                       <input type="text" class="form-control" id="description" placeholder="Reason">
                    </div>
                     </div>
                    </form>
                  <!--</div>-->
                  ...
                  <div class="modal-footer">
                    ...
                    <button type="button" id="add_wallet_money" class="btn btn-primary">Save changes</button>
            ...
            <button type="button" class="btn btn-sm btn-info mr-3" data-toggle="modal" data-target="#statmentModal">View Statment </button>
            
           
                
                <!-- Modal -->
                <div class="modal fade" id="statmentModal" tabindex="-1" role="dialog" aria-labelledby="statmentModalLabel" aria-hidden="true">
                  <div class="modal-dialog" style="max-width: 50%;" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="statmentModalLabel">Modal title</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                          <span aria-hidden="true">&times;</span>
                        </button>
                      </div>
                ...
                ?>
            <button type="button" class="btn btn-sm btn-info mr-3" data-toggle="modal" style="background:blue;" data-target="#exampleModal">Create Payment Link</button>
...
$(document).ready(function () {
   $('#add_wallet_money').click(function () {
      alert("test");
      var wallet_amount = $("#wallet_amount").val();
      var suggested_description = $("#suggested_description").val();
      var description = $("#description").val();
      var email_id = "<?= $get_user_details[0]['email_id'] ?>";
      var user_id = '<?=$get_user_details[0]['register_id'] ?>';
        console.log("user_id" +user_id);
      var formData = new FormData();
      formData.append("wallet_amount", wallet_amount);
      formData.append("suggested_description", suggested_description);
      formData.append("description", description);
      formData.append("email_id", email_id);
       formData.append("user_id", user_id);
        $.ajax({
    		type: 'POST',
    		url: "<?php echo base_url('user_details/addWallet'); ?>",
    		data: formData,
    		contentType: false,
    		processData: false,
    		dataType: 'json',
