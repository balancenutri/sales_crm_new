...
<div id="order_form_section">
	...
	<div class="form-group m-form__group row">
    	...
    	<script>
    	    function validateFrequency(elem){
    	        if(elem.value=="Outside Meals"){
    	            document.getElementById('meal_frequency').disabled=false;
    	        }else{
    	              document.getElementById('meal_frequency').disabled=true;
    	        }
    	    }
    	</script>
	...
	<div class="form-group m-form__group row">
		...
		<div class="col-lg-9 col-md-9 col-sm-12">
			...
			<div class="row form-group">
			    <div class="col-12">
					...
					<select id="clinical_condition" name="clinical_condition[]" class="form-control m-input" multiple="Clinical condition" title="Clinical Condition" placeholder="Clinical Conditions">
						...
						<option value="Micronutrient deficiency">Micronutrient deficiency</option>
						<option value="Kidney Disorders">Kidney Disorders</option>
						<option value="Gut Health Issues">Gut Health Issues</option>
			...
			<div class="row form-group">
				<div class="col-12">
					...
					<select id="diet_history" name="diet_history[]" class="form-control m-input" multiple="diet history" title="Diet History" placeholder="Diet History">
						...
						<option value="Tried Diet But No Consistency">Tried Diet But No Consistency</option>
						<option value="Never Tried Diets">Never Tried Diets</option>
					
						<option value="Is On a Diet">Is On a Diet</option>
							<option value="Got Results Want to lose more">Got Results Want to lose more</option>
					</select>
				</div>
			</div>
			<div class="row form-group">
			...
			<div class="form-group m-form__group row">
    		<label class="col-form-label col-lg-3 col-sm-12">Meal Management:</label>
    		<div class="col-lg-9 col-md-9 col-sm-12">
    			<select name="meal_management" class="form-control m-input statusClass " onchange="validateFrequency(this)">
    				<option value="">Select </option>
    		
    				<option data-id="home_cooked" value="Home Cooked" data-stage="home_cooked">Home Cooked</option>
    				<option data-id="outside_meals" value="Outside Meals" data-stage="outside_meals">Outside Meals</option>
    			
    			</select>
    		</div>
    		<label class="col-form-label col-lg-3 col-sm-12">Frequency:</label>
    			<div class="col-lg-9 col-md-9 col-sm-12">
    			<select name="meal_frequency" class="form-control m-input statusClass " id="meal_frequency"  disabled>
    				<option value="">Select </option>
    		
    				<option data-id="outside_meals" value="Once A Week" data-stage="Once A Week">Once A Week</option>
    				<option data-id="outside_meals" value="Twice A Week" data-stage="Twice A Week">Twice A Week</option>
    				<option data-id="outside_meals" value="More Than Twice A Week" data-stage="More Than Twice A Week">More Than Twice A Week</option>
	...
	<div class="form-group m-form__group row">
		...
		<div class="col-lg-9 col-md-9 col-sm-12">
			...
			<select name="suggested_program" class="form-control m-input  suggested_program" style="margin-top: 10px;">
            	...
            	<option data-id="7" value="SlimSmart30">Slim Smart</option>
            	...
            	<option data-id="19" value="Sphoorti">Sphoorti</option>
            		<option data-id="136" value="PregnancyProgram">Pregnancy Program</option>
    		...
    		<div class="form-group m-form__group row d-none" id="link_expiry">
    			...
    			<div class="form-group m-form__group row">
			<label class="col-form-label col-lg-3 col-sm-12">Communication:</label>
			<div class="col-lg-9 col-md-9 col-sm-12">
				<div class="m-radio-inline" style="margin-left: 25px;">
					<label class="m-radio" style="font-weight: 500;">
					<input type="radio" name="Communication" value="Asking Queries"> Asking Queries
					<span></span>
					</label>
					<label class="m-radio" style="font-weight: 500;">
					<input type="radio" name="Communication" value="Cold Replies">Cold Replies
					<span></span>
					</label>
    			...
    			<div class="form-group m-form__group row">
			<label class="col-form-label col-lg-3 col-sm-12">Awarness Level:</label>
			<div class="col-lg-9 col-md-9 col-sm-12">
				<div class="m-radio-inline" style="margin-left: 25px;">
					<label class="m-radio" style="font-weight: 500;">
					<input type="radio" name="awareness_lavel" value="Low"> Low
					<span></span>
					</label>
					<label class="m-radio" style="font-weight: 500;">
					<input type="radio" name="awareness_lavel" value="Medium"> Medium
					<span></span>
					</label>
					<label class="m-radio" style="font-weight: 500;">
					<input type="radio" name="awareness_lavel" value="High"> High
					<span></span>
					</label>
				</div>
			</div>
	...
	$(document).ready(function (){
        ...
        */
        $('.suggested_program').on('change',function(){
            ...
            }else if(program== 'PregnancyProgram' ){
               program_options += '<option value="9">90 Days</option><option value="12">120 Days</option><option value="15">150 Days</option><option value="18">180 Days</option>';
            }else{
	   ...
	   //=========================================================================================
	    ...
	    $('.sub_status').on('change',function(){
	        ...
	        if(status=='To Pay' || status=='Pay Later'){
	            ...
	            html+='<option value="Gone Silent">Gone Silent</option><option value="Get Back Later">Get Back Later</option><option value="Comparision">Comparision</option>';
	            ...
	            html+='<option value="With The Program Purchase">With The Program Purchase</option><option value="USP/Head Mentor">USP/Head Mentor</option><option value="Build trust/faith">Build trust/faith</option><option value="Speak to family">Speak to family</option><option value="not comfortable online">Not comfortable online</option>';
	        }else if(status == 'Price Sensitive'){
	            option++;
	            // alert(status);Not for special stacks
	            ...
	            //html+='<option value="Comparision">Comparision</option><option value="No Basic Stack">No Basic Stack</option><option value="Need Convencing">Need Convencing</option><option value="Not In Range">Not In Range</option>';
	                html+='<option value="Comparision">Comparision</option><option value="Not In Range">Not In Range</option><option value="Not for special stacks">Not for special stacks</option>';   
