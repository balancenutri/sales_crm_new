...
" ><?php echo $title; ?></h3>
                    ...
                    <script>
                     $(window).on('load',function(){
                      ...
                      var addData =
                    '<div class="m-section"> <div class="m-section__content table-responsive"> <table class="table table-bordered m-table m-table--border-brand" id="maintenance_table_data" style="width: 90%;!important"> <thead style="background-color: #c4c5d6;"><tr><th>Lead Details</th><th>IMF Window</th> <th>Date</th> <th>Source</th> </tr></thead> </table> </div> </div>';
                ...
                $('#maintenance_table_data').DataTable({
                    ...
                    "ajax": {
                        "type": "GET",
                        "url" : "<?php echo base_url()?>lead/get_imf_campaign_details_data",
