...
GROUP BY
   ...
   public function  get_imp_campaign_data_query($get_parameters = false){
...
LEFT JOIN lead_action la ON
    lm.email = la.email
WHERE
   lm.phone != ''  AND CHAR_LENGTH(lm.phone) > 4 and enquiry_from = 'BN IMF Campaign 2023' and LCASE(la.assign_to) ='".strtolower($login_name)."'
GROUP BY
    lm.email
    ";
