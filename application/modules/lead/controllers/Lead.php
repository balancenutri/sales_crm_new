...
// avinash added this for ideal weight
    ...
    public function get_imf_campaign_details_data(){
        $data['spin_details_data'] = $this->lead_model->get_imp_campaign_data_query($_GET);
        /*echo '<pre>';
        print_r($data);
        die;*/
        echo json_encode($data);
    ...
    function imf_campaign(){
        $data['title'] = "IMF Campaign List";
         $data['page']='lead';
        // $data['spin_details_data'] = $this->lead_model->get_spin_history_data_query();
    //     print_r($data);
    //   echo  $this->db->last_query();
    //     die();
        display_view('imf_campaign',$data);
    }
