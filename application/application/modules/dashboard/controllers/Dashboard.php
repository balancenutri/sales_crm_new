  ...
  <tbody class="text-center">
    ...
    <tr>
      ...
      <td style="width:20%">
        ...
        $headers[] = 'Cc: '.$this->session->balance_session['email_id'].',siddhesh.kuveskar@balancenutrition.in,mohammed.umer@balancenutrition.in,saurabh.bansode@balancenutrition.in,clientservices@balancenutrition.in,khyatirupani@balancenutrition.in,digitalmarketing@balancenutrition.in';
       $headers[] = 'Bcc: vikram.gupta@balancenutrition.in,vaibhav.gonjari@balancenutrition.in';
...
// avinash added this code for check review submit step
    ...
    //Email to Manager/Vishal Sir
        ...
        if(strtolower($email)=='aayushi.dubey@balancenutrition.in'){
         $headers[] = 'Cc: '.$email.',siddhesh.kuveskar@balancenutrition.in,mohammed.umer@balancenutrition.in,saurabh.bansode@balancenutrition.in,clientservices@balancenutrition.in,khyatirupani@balancenutrition.in,digitalmarketing@balancenutrition.in';
          
        }else{
            if(strtolower($email)=='chelsi.dhelawat@balancenutrition.in' || strtolower($email)=='shailee.sanghavi@balancenutrition.in' ){
                $headers[] = 'Cc: '.$email.',siddhesh.kuveskar@balancenutrition.in,mohammed.umer@balancenutrition.in,saurabh.bansode@balancenutrition.in,clientservices@balancenutrition.in,aayushi.dubey@balancenutrition.in,khyatirupani@balancenutrition.in,digitalmarketing@balancenutrition.in,anisha.powale@balancenutrition.in';
                
            }else if(strtolower($email)=='mili.jain@balancenutrition.in' || strtolower($email)=='dhwani.lade@balancenutrition.in'){
                $headers[] = 'Cc: '.$email.',siddhesh.kuveskar@balancenutrition.in,mohammed.umer@balancenutrition.in,saurabh.bansode@balancenutrition.in,clientservices@balancenutrition.in,dhanashree.chawan@balancenutrition.in,khyatirupani@balancenutrition.in,digitalmarketing@balancenutrition.in';
                
            }else{
            
              $headers[] = 'Cc: '.$email.',siddhesh.kuveskar@balancenutrition.in,mohammed.umer@balancenutrition.in,saurabh.bansode@balancenutrition.in,clientservices@balancenutrition.in,aayushi.dubey@balancenutrition.in,khyatirupani@balancenutrition.in,digitalmarketing@balancenutrition.in';
