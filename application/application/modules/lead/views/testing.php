            ...
            // $(document).ready(function(){
                ...
                $('#lead_details_data').DataTable({
                    ...
                    "ajax": {
                        ...
                        "processing": true,
                        "serverSide": true,
                        "url" : "<?php echo base_url()?>lead/get_order_details_data__"+get_parameters,
            ...
            return '<input type="checkbox" class="export_check" value="'+data.id+'" data-user_phone="'+data.phone+'"  data-user_email="'+data.email+'">';}},
                        ...
                        { "data": null,  "render": function ( data, type, full, meta ) {
                            ...
                            if(urlParams['lead_by'] == "bs"){
                                ...
                                return '<b>Program Name:</b> '+data.program_name+'<br><b>Pro. Dur. Days:</b> '+data.prog_duration+'<br><b>Wt. Diff.:</b> '+wtDiff+'<br><b>Mentor :</b> '+data.mentor;
                            }else{
                                return '<b>Health Category:</b> '+data.health_category+'<br><b>Medi. Issues:</b> '+data.health_issues+'<br><b>Curr. Wt.:</b> '+data.weight+'<br><b>Height:</b> '+data.height+'<br><b>BMI:</b> '+data.body_mass_index+'<br><b>Ideal Wt.:</b> '+data.ideal_weight+'<br><b>Mentor:</b> '+data.omr_mentor;
                            }
                            
                        }},
                        /*{ "data": null,  "render": function ( data, type, full, meta ) {
            return '<b>Source:</b> '+data.lead_source+'<br><b>L. Type:</b> '+data.lead_type+'<br><b>Status:</b> '+data.lead_status}},*/
                        { "data": null },
                        { "data": null },
                        { "data": null },
                        { "data": "assign_to" },
                        ...
                        },
                        {
                            ...
                            targets: [4], render: function (a, b, data, s) {
                                ...
                                if (data.assign_to == null || data.assign_to == "") {
                                    ...
                                    return "<b>Name:</b> "+data.assign_to +"<br><b>Date:</b> "+ data.assign_date
                                }
