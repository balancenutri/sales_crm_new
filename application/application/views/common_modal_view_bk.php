  ...
  <tbody class="text-center">
    <tr>
      ...
      <td style="padding-right: 0px;background:#ABEBC6">
          <input type="text" class="form-control" id="goal_lead" style="width:70%" name="goal_lead" readonly oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" />
      </td>
      <td style="width:20%;background:#ABEBC6">
          <input type="text" class="form-control" id="goal_consult_ratio" name="goal_consult_ratio" readonly style="width:70%" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" />
      </td>
    </tr>
    <tr>
      <th>Consultation</th>
      ...
      <td style="width:20%;background:#ABEBC6">
          <input type="text" class="form-control" id="consultation_sale_ratio" name="consultation_sale_ratio" style="width:70%" readonly oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" />
      </td>
    </tr>
    <!--<tr>
    ...
    <tr>
      ...
      <td style="width:20%;background:#ABEBC6">
          <input type="text" class="form-control" id="unit_goal"  name="unit_goal" style="width:70%"  oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" />
        </td>
      <td style="width:20%;background:#ABEBC6">
          <input type="text" class="form-control" id="unit_goal_ratio" name="unit_goal_ratio" style="width:70%" readonly oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" />
        </td>
    </tr>
    <tr>
      <th>Sales Amount</th>
      ...
      <!--<td>- -</td>-->
      <td style="width:20%;background:#ABEBC6">
          <input type="text" class="form-control" id="sale_goal" name="sale_goal" style="width:70%" readonly oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" />
      </td>
      <td style="width:20%;background:#ABEBC6">
          <input type="text" class="form-control" id="sale_goal_per_unit"  name="sale_goal_per_unit" style="width:70%"  oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');"/>
      </td>
    </tr>
  </tbody>
</table>
