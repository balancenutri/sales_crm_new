                     ...
                     success: function (data) 
                     {
                         ...
                         {  //post reminder WA text
                            ...
                            swal({
                                 ...
                                 confirmButtonColor: '#3085d6',
                                 cancelButtonColor: '#d33',
                                 confirmButtonText: '<a href="https://wa.me/+91'+whats_phone+'/?text='+whats_msg+'" target="_blank"><i class="fa fa-whatsapp"></i>Text on WhatsApp!</a>'
                                 })         
            ...
            case 'today_fus_notification':
                ...
                $('#sales_summary_popup_table_data').DataTable({
                    ...
                    "columns": [
                        ...
                        return '<a href="<?= base_url()?>user_details?user_email='+data.email+'&user_status=lead" target="_blank">'+data.email+'</a><br/><a href="https://wa.me/+91'+whats_phone+'/?text='+whats_msg+'" target="_blank">'+data.phone+'</a>';}},
                        { "data": "reminder_dt" },
                        { "data": "followup_from" },
                        { "data": "key_insight" }
            ...
            case 'calls_scheduled':
                ...
                $('#calls_scheduled_table_data').DataTable({
                    ...
                    "columns": [
                        ...
                        whats_msg = 'Hi '+data.name+',%0a%0aSr. Nutritionist <?=$_SESSION['balance_session']['first_name'];?> here from Balance Nutrition.%0aYou have requested a consultation with me today at '+data.time_slot+' IST. I will be connecting with you over a call at that time.%0a%0aBefore we speak, do fill out this form: https://www.balancenutrition.in/health-score%0aIt will give me a good insight into your current health profile.';         
                        return '<a href="https://wa.me/+91'+whats_phone+'/?text='+whats_msg+'" target="_blank">'+data.phone+'</a>';}},
                        { "data": "call_date" },
                        { "data": "time_slot" },
                        { "data": null,  "render": function ( data, type, full, meta ) {
            ...
            case 'due_tomorrow':
                ...
                $('#due_tomorrow_table_data').DataTable({
                    ...
                    "columns": [
                        ...
                        return '<a href="<?= base_url()?>user_details?user_email='+data.email_id+'&user_status=client" target="_blank">'+data.full_name+'</a><br><a href="mailto:'+data.email_id+'">'+data.email_id+'</a><br><a href="https://wa.me/+91'+whats_phone+'/?text='+whats_msg+'" target="_blank">'+data.phone+'</a>';}},
...
$(document).ready(function(){
               ...
               success:function(data){
                  ...
                  for(var i=0;i<data.length;i++){
                      ...
                      if(data[i].sale_month == 0){
                          ...
                          var sale_amount = data[i].sale_month[0]['amt'];
                          var sale_unit = data[i].sale_month[0]['unit'];
                          var ratio_unit=(((data[i].sale_month[0]['amt'])/goal_amount)*100).toFixed(2)+"%";
					...
					snapshot +="<div class='ml-3 card_detail'>";
					...
					snapshot +="<div class='d-flex flex-column'> <span><b>Lead in Hand </b></span> <span><b>Consulations</b></span> <span><b>Hot</b></span>";
					snapshot +="<ul class='pb-2'>"+data[i].substatus_status+"</ul></div>";
            ...
            $.ajax({
               ...
               success:function(data){
                //   console.log(data);
                  ...
                  $('#const_sale_ratio').html((((data.consult_sale)/data.consultation_done)*100).toFixed(2)+" %");
    ...
    $(function(){
        ...
        $('#unit_goal').keyup(function(){
            ...
            var sal_goal = $('#sale_goal').val();
            var sale_unit = $('#unit_goal').val();
            var goal_unit = $('#sale_goal_per_unit').val();
            if(sale_unit.length>1 && goal_unit.length>3 ){
                $('#sale_goal').val(Math.round(parseInt($('#unit_goal').val())*(parseInt($('#sale_goal_per_unit').val()))));
                $('#sale_goal').attr('readonly',false);
            }
            sal_goal = $('#sale_goal').val();
            if(sal_goal.length>3){
            sale_unit = $('#unit_goal').val();
            sale_ratio = $('#unit_goal_ratio').val();
            consultation_unit = $('#goal_consult').val();
