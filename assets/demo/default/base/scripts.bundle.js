var mApp = function() {
    ...
    return {
        ...
        initScroller: function(e, t) {
            mUtil.isMobileDevice() ? e.css("overflow", "auto") : e.mCustomScrollbar({
                scrollInertia: 0,
                autoDraggerLength: !0,
                autoHideScrollbar: !0,
        ...
        block: function(e, t) {
            ...
            if ("body" == e) r.css.top = "50%", $.blockUI(r);
            else {
                (i = $(e)).block(r)
            }
        },
...
$(document).ready(function() {
        ...
        e.fn.mMenu = function(t) {
            var a = this,
                ...
                o = {
                    ...
                    build: function() {
                        n.on("click", ".m-menu__toggle", o.handleSubmenuAccordion), ("dropdown" === o.getSubmenuMode() || o.isConditionalSubmenuDropdown()) && (n.on({
                    ...
                    handleSubmenuDropdownClick: function(t) {
                        if ("accordion" !== o.getSubmenuMode()) {
                            ...
                            "accordion" != a.data("menu-submenu-mode") && (0 == a.hasClass("m-menu__item--hover") ? (a.addClass("m-menu__item--open-dropdown"), o.showSubmenuDropdown(a)) : (a.removeClass("m-menu__item--open-dropdown"), o.hideSubmenuDropdown(a, !0)), t.preventDefault())
                        }
                    },
                    ...
                    handleSubmenuAccordion: function(t, n) {
                        var i = e(n || this);
                        if ("dropdown" !== o.getSubmenuMode() || "accordion" == i.closest(".m-menu__item").data("menu-submenu-mode")) {
                            var l = i.closest("li"),
                                r = l.children(".m-menu__submenu, .m-menu__inner");
                            if (!i.closest(".m-menu__item").hasClass("m-menu__item--open-always") && r.length > 0) {
                                t.preventDefault();
                                var s = a.options.accordion.slideSpeed;
                                if (!1 === l.hasClass("m-menu__item--open")) {
                                    if (!1 === a.options.accordion.expandAll) {
                                        var d = i.closest(".m-menu__nav, .m-menu__subnav").find("> .m-menu__item.m-menu__item--open.m-menu__item--submenu:not(.m-menu__item--expanded):not(.m-menu__item--open-always)");
                                        d.each(function() {
                                            e(this).children(".m-menu__submenu").slideUp(s, function() {
                                                o.scrollToItem(i)
                                            }), e(this).removeClass("m-menu__item--open")
                                        }), d.length > 0 && !0
                                    }
                                    r.slideDown(s, function() {
                                        o.scrollToItem(i)
                                    }), l.addClass("m-menu__item--open")
                                } else r.slideUp(s, function() {
                                    o.scrollToItem(i)
                                }), l.removeClass("m-menu__item--open")
                            }
                    ...
                    hideSubmenuDropdown: function(t, a) {
                        a && t.removeClass("m-menu__item--hover"), t.removeData("hover"), t.data("menu-dropdown-toggle-class") && e("body").removeClass(t.data("menu-dropdown-toggle-class"));
                        var n = t.data("timeout");
                        t.removeData("timeout"), clearTimeout(n)
                    },
                    showSubmenuDropdown: function(t) {
                        ...
                        }), o.adjustSubmenuDropdownArrowPos(t), t.addClass("m-menu__item--hover"), t.data("menu-dropdown-toggle-class") && e("body").addClass(t.data("menu-dropdown-toggle-class")), "accordion" === o.getSubmenuMode() && a.options.accordion.autoScroll && mApp.scrollTo(t.children(".m-menu__item--submenu"))
                    },
                    resize: function(t) {
                    ...
                    createSubmenuDropdownClickDropoff: function(t) {
                        ...
                        e("body").after(n), n.on("click", function(a) {
                            a.stopPropagation(), a.preventDefault(), e(this).remove(), alert(1), o.hideSubmenuDropdown(t, !0)
                        })
                    },
                    ...
                    setActiveItem: function(t) {
                        o.resetActiveItem();
                        (t = e(t)).addClass("m-menu__item--active"), t.parents(".m-menu__item--submenu").each(function() {
            ...
            e('.m-menu__nav .m-menu__item.m-menu__item--submenu.m-menu__item--hover[data-menu-submenu-toggle="click"]').each(function() {
                ...
                if (menu = a.mMenu(), "dropdown" === menu.getSubmenuMode() && 0 == e(t.target).is(a) && 0 == a.find(e(t.target)).length) {
                    a.find('.m-menu__item--submenu.m-menu__item--hover[data-menu-submenu-toggle="click"]').each(function() {
                        menu.hideDropdown(e(this))
                    })
                }
            })
        })
                ...
                o = {
                    ...
                    setupTooltips: function() {
                        if (a.options.tooltips) {
                            var t = n.hasClass("m-portlet--collapse") || n.hasClass("m-portlet--collapsed"),
                    ...
                    toggle: function() {
                        n.hasClass("m-portlet--collapse") || n.hasClass("m-portlet--collapsed") ? o.expand() : o.collapse()
                    },
                    collapse: function() {
                        !1 !== o.eventTrigger("beforeCollapse") && (a.body.slideUp(a.options.bodyToggleSpeed, function() {
                            o.eventTrigger("afterCollapse")
                        }), n.addClass("m-portlet--collapse"), o.setupTooltips())
                    },
                    expand: function() {
                        !1 !== o.eventTrigger("beforeExpand") && (a.body.slideDown(a.options.bodyToggleSpeed, function() {
                            o.eventTrigger("afterExpand")
                        }), n.removeClass("m-portlet--collapse"), n.removeClass("m-portlet--collapsed"), o.setupTooltips())
                    },
        ...
        e.fn.mToggle = function(t) {
            var a = this,
                ...
                o = {
                    ...
                    toggle: function() {
                        return "off" == a.state ? o.toggleOn() : o.toggleOff(), o.eventTrigger("toggle"), a
                    },
                    toggleOn: function() {
                    ...
                    eventTrigger: function(e) {
                        for (a.trigger(e), i = 0; i < a.events.length; i++) {
                            var t = a.events[i];
                            if (t.name == e) {
                                if (1 != t.one) return t.handler.call(this, a);
                                if (0 == t.fired) return a.events[i].fired = !0, t.handler.call(this, a)
            ...
            return o.run.apply(this, [t]), a.getState = function() {
                return a.state
            }, a.toggle = function() {
                return o.toggle()
            }, a.toggleOn = function() {
    ...
    function(e) {
        e.fn.mWizard = function(t) {
            var a = this,
                n = e(this),
                o = {
                    run: function(e) {
                        return n.data("wizard") ? a = n.data("wizard") : (o.init(e), o.build(), n.data("wizard", a)), a
                    },
                    init: function(t) {
                        a.steps = a.find(".m-wizard__step"), a.progress = a.find(".m-wizard__progress .progress-bar"), a.btnSubmit = a.find('[data-wizard-action="submit"]'), a.btnNext = a.find('[data-wizard-action="next"]'), a.btnPrev = a.find('[data-wizard-action="prev"]'), a.btnLast = a.find('[data-wizard-action="last"]'), a.btnFirst = a.find('[data-wizard-action="first"]'), a.options = e.extend(!0, {}, e.fn.mWizard.defaults, t), a.events = [], a.currentStep = 1, a.totalSteps = a.steps.length, a.options.startStep > 1 && o.goTo(a.options.startStep), o.updateUI()
                    },
                    build: function() {
                        a.btnNext.on("click", function(e) {
                            e.preventDefault(), o.goNext()
                        }), a.btnPrev.on("click", function(e) {
                            e.preventDefault(), o.goPrev()
                        }), a.btnFirst.on("click", function(e) {
                            e.preventDefault(), o.goFirst()
                        }), a.btnLast.on("click", function(e) {
                            e.preventDefault(), o.goLast()
                        }), a.find(".m-wizard__step a.m-wizard__step-number").on("click", function() {
                            var t, a = e(this).parents(".m-wizard__step");
                            e(this).parents(".m-wizard__steps").find(".m-wizard__step").each(function(n) {
                                a.is(e(this)) && (t = n + 1)
                            }), t && o.goTo(t)
                        })
                    },
                    ...
                    goTo: function(e) {
                        if (e !== a.currentStep) {
                            return !1 !== ((e = e ? parseInt(e) : o.getNextStep()) > a.currentStep ? o.eventTrigger("beforeNext") : o.eventTrigger("beforePrev")) && (a.currentStep = e, o.updateUI(), o.eventTrigger("change")), e > a.startStep ? o.eventTrigger("afterNext") : o.eventTrigger("afterPrev"), a
                        }
                    },
                    updateUI: function(e) {
                        o.updateProgress(), o.handleTarget(), o.setStepClass(), a.find(".m-wizard__step").removeClass("m-wizard__step--current").removeClass("m-wizard__step--done");
                        for (var t = 1; t < a.currentStep; t++) a.find(".m-wizard__step").eq(t - 1).addClass("m-wizard__step--done");
                        a.find(".m-wizard__step").eq(a.currentStep - 1).addClass("m-wizard__step--current")
                    },
                    isLastStep: function() {
                    ...
                    setStepClass: function() {
                        o.isLastStep() ? n.addClass("m-wizard--step-last") : n.removeClass("m-wizard--step-last"), o.isFirstStep() ? n.addClass("m-wizard--step-first") : n.removeClass("m-wizard--step-first"), o.isBetweenStep() ? n.addClass("m-wizard--step-between") : n.removeClass("m-wizard--step-between")
                    },
                    goNext: function() {
                    ...
                    updateProgress: function() {
                        if (a.progress)
                            if (n.hasClass("m-wizard--1")) {
                                var e = a.currentStep / a.totalSteps * 100,
                                    t = n.find(".m-wizard__step-number").width();
                                a.progress.css("width", "calc(" + e + "% + " + t / 2 + "px)")
                            } else if (n.hasClass("m-wizard--2")) {
                            if (1 === a.currentStep) return;
                            n.find(".m-wizard__step").eq(0);
                            var o = (a.currentStep - 1) * (1 / (a.totalSteps - 1) * 100);
                            mUtil.isInResponsiveRange("minimal-desktop-and-below") ? a.progress.css("height", o + "%") : a.progress.css("width", o + "%")
                        } else {
                            e = a.currentStep / a.totalSteps * 100;
                            a.progress.css("width", e + "%")
                        }
                    },
                    handleTarget: function() {
                        var e = a.steps.eq(a.currentStep - 1),
                            t = n.find(e.data("wizard-target"));
                        n.find(".m-wizard__form-step--current").removeClass("m-wizard__form-step--current"), t.addClass("m-wizard__form-step--current")
                    },
            ...
            return o.run.apply(this, [t]), a.goNext = function() {
                return o.goNext()
            }, a.goPrev = function() {
                return o.goPrev()
            }, a.goLast = function() {
    ...
    function(e) {
        ...
        var t, a, n, o, i, l, r, s = this._chart.ctx,
            d = this._view,
            c = d.borderWidth,
            u = this._chart.options.barRadius ? this._chart.options.barRadius : 0;
        if (d.horizontal ? (t = d.base, a = d.x, n = d.y - d.height / 2, o = d.y + d.height / 2, i = a > t ? 1 : -1, l = 1, r = d.borderSkipped || "left") : (t = d.x - d.width / 2, a = d.x + d.width / 2, n = d.y > 2 * u ? d.y - u : d.y, i = 1, l = (o = d.base) > n ? 1 : -1, r = d.borderSkipped || "bottom"), c) {
            var m = Math.min(Math.abs(t - a), Math.abs(n - o)),
                p = (c = c > m ? m : c) / 2,
                f = t + ("left" !== r ? p * i : 0),
                g = a + ("right" !== r ? -p * i : 0),
                h = n + ("top" !== r ? p * l : 0),
                b = o + ("bottom" !== r ? -p * l : 0);
            f !== g && (n = h, o = b), h !== b && (t = f, a = g)
        }
        s.beginPath(), s.fillStyle = d.backgroundColor, s.strokeStyle = d.borderColor, s.lineWidth = c;
        var v = [
                [t, o],
                [t, n],
                [a, n],
            ...
            _ = ["bottom", "left", "top", "right"].indexOf(r, 0); - 1 === _ && (_ = 0);
        var w = e(0);
        s.moveTo(w[0], w[1]);
        for (var k = 1; k < 4; k++) {
            w = e(k), nextCornerId = k + 1, 4 == nextCornerId && (nextCornerId = 0), nextCorner = e(nextCornerId), width = v[2][0] - v[1][0], height = v[0][1] - v[1][1], x = v[1][0], y = v[1][1];
            var C;
            (C = u) > height / 2 && (C = height / 2), C > width / 2 && (C = width / 2), s.moveTo(x + C, y), s.lineTo(x + width - C, y), s.quadraticCurveTo(x + width, y, x + width, y + C), s.lineTo(x + width, y + height - C), s.quadraticCurveTo(x + width, y + height, x + width - C, y + height), s.lineTo(x + C, y + height), s.quadraticCurveTo(x, y + height, x, y + height - C), s.lineTo(x, y + C), s.quadraticCurveTo(x, y, x + C, y)
        }
        s.fill(), c && s.stroke()
        ...
        errorPlacement: function(e, t) {
            var a = $(t).closest(".m-form__group-sub").length > 0 ? $(t).closest(".m-form__group-sub") : $(t).closest(".m-form__group"),
                n = a.find(".m-form__help");
            0 === a.find(".form-control-feedback").length && (n.length > 0 ? n.before(e) : $(t).closest(".input-group").length > 0 ? $(t).closest(".input-group").after(e) : $(t).is(":checkbox") ? $(t).closest(".m-checkbox").find(">span").after(e) : $(t).after(e))
        },
        highlight: function(e) {
            var t = $(e).closest(".m-form__group-sub").length > 0 ? $(e).closest(".m-form__group-sub") : $(e).closest(".m-form__group");
            console.log("add" + t.attr("class")), t.addClass("has-danger")
        },
        unhighlight: function(e) {
            ($(e).closest(".m-form__group-sub").length > 0 ? $(e).closest(".m-form__group-sub") : $(e).closest(".m-form__group")).removeClass("has-danger")
        },
        success: function(e, t) {
            var a = $(e).closest(".m-form__group-sub").length > 0 ? $(e).closest(".m-form__group-sub") : $(e).closest(".m-form__group");
        ...
        init: function() {
            0 !== e.length && (e.mOffcanvas({
                ...
                mApp.block(e), setTimeout(function() {
                    mApp.unblock(e), o.removeClass("m--hide"), i()
                }, 1e3)
            }))
        }
    }
